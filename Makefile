...
demo-artifact-api:
	ACE_MODEL_MODE=development_artifact PYTHONPATH=services/api python3 -m uvicorn app.main:app --reload --port 8000

verify-artifact-runtime:
	PYTHONPATH=services/api python3 services/api/scripts/verify_development_runtime.py
